        ...
        try {
            ...
            if (response.ok) {
                ...
                if (result.success) {
                    ...
                    console.log('✅ Loaded conversations from server:', this.conversations.length);
                    console.log('📄 Conversation details:', this.conversations);
            ...
            if (savedConversations) {
                ...
                console.log('📦 Loaded from localStorage:', this.conversations.length);
            }
        }
    }
                ...
                <div class="conversation-card" data-conversation-id="${conversation.id}">
                    <div class="conversation-header">
                        <div class="conversation-user">
                            <i class="fas fa-user"></i> ${conversation.userEmail || 'Anonymous User'}
                    ...
                    <div class="conversation-meta">
                        ...
                        <button class="btn btn-sm btn-secondary" onclick="chatbotManager.viewConversation('${conversation.id}')">
                            <i class="fas fa-eye"></i> View
                        </button>
                        <button class="btn btn-sm btn-danger" onclick="chatbotManager.deleteConversation('${conversation.id}')" title="Delete Conversation">
  ...
  FoodisChatbot.init({
    ...
    async clearAllConversations() {
        ...
        try {
            ...
            this.showNotification('Failed to clear all conversations', 'error');
        }
    }
