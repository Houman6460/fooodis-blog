...
function initPostStats() {
    ...
    // Prevent infinite loops and duplicate initialization
    ...
    // Clear any existing intervals to prevent loops
    if (window.postStatsInterval) {
        clearInterval(window.postStatsInterval);
        window.postStatsInterval = null;
    }
